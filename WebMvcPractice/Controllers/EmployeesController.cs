...
namespace WebMvcPractice.Controllers
{
    ...
    {
        private readonly ActsJuly2024CodeFirstContext _context;

        public EmployeesController(ActsJuly2024CodeFirstContext context)
        {
            _context = context;
        }
        ...
        {
            var actsJuly2024CodeFirstContext = _context.Employees.Include(e => e.DeptNoNavigation);
            return View(await actsJuly2024CodeFirstContext.ToListAsync());
        }
